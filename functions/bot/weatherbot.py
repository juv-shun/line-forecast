...
class WeatherBot(LineBotApi):
    __timing_choices = {'A': '06:15', 'B': '06:30', 'C': '06:45',
                        'D': '07:00', 'E': '07:15', 'F': '07:30',
                        'G': '07:45', 'H': '08:00', 'I': '08:15',
                        'J': '08:30', 'K': '08:45'}
    ...
    def reply(self, event):
        ...
        if event['type'] == 'message' and event['message']['type'] == 'text':
            logger.info("Input type: message, Input message: %s"
                        % event['message']['text'])
            result = self.__react(user_id=user_id,
                                  method=event['message']['text'])
        ...
        # メッセージ送信
        self.reply_message(messages=TextSendMessage(text=message),
